...
public class VariableAndComposer implements LinguisticVariable {

    private final LinguisticVariable variable1;
    private final Variable variable;

    VariableAndComposer(Variable variable, LinguisticVariable variable1) {
    ...
    public List<Double> getMembershipDegrees() {
        ...
        for(int i=0; i<degrees.size(); i++){
            myList.add(Math.min(degrees.get(i),degrees1.get(i)));
        }
        return myList;
    }
    ...
    public String getName() {
        return variable.getName()+" and " +variable1.getName();
    }
