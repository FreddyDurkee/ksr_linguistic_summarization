...
public class LinguisticSummarizerConnectedOrTest {
    ...
    public static void setUpClass(){
        ...
        summarizer = summarizer1.or(summarizer2);
    ...
    public void calculateT4Measure() {
        ...
        // Then
        Double expectedT4 = Math.abs((3.0/7 * 6.0/7) - 1.0);
